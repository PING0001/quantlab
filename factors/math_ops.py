# -*- coding: utf-8 -*-
"""
Math / control-flow functions for the expression DSL.
Ported from vnpy alpha dataset math_function.py.
"""
...
def quesval(threshold: float, feature1: DataProxy, feature2: DataProxy | float, feature3: DataProxy | float) -> DataProxy:
...
def quesval2(threshold: DataProxy, feature1: DataProxy, feature2: DataProxy | float, feature3: DataProxy | float) -> DataProxy:
