...
数据名称 | API | 描述 | 最低分值
-- | -- | -- | --
[日线数据](https://tushare.pro/document/2?doc_id=27) | daily | 全部历史，交易日每日15点～17点之间更新 | 120起
[周线数据](https://tushare.pro/document/2?doc_id=144) | weekly | 全部历史，每周五15点～17点之间更新 | 2000
[月线数据](https://tushare.pro/document/2?doc_id=145) | monthly | 全部历史，每月更新 | 2000
...
[港股日线数据](https://tushare.pro/document/2?doc_id=192) | hk_daily | 全部历史，每日更新 | 1000元
[港股分钟数据](https://tushare.pro/document/2?doc_id=304) | hk_mins | 全部历史，每日更新 | 2000元
